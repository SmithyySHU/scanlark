...
- `OPERATIONS_QUOTE_PREFIX`
- `OPERATIONS_WORK_ORDER_PREFIX`
- `OPERATIONS_DEFAULT_CURRENCY`
- `OPERATIONS_DEFAULT_QUOTE_VALID_DAYS`
- `OPERATIONS_BUSINESS_VAT_REGISTERED`
- `OPERATIONS_VAT_RATE_PERCENT`
- `OPERATIONS_SERVICE_PREFIX`
- `OPERATIONS_DEFAULT_SERVICE_CURRENCY`
- `OPERATIONS_DEFAULT_REPORT_DAY`
- `OPERATIONS_DEFAULT_REVIEW_INTERVAL_DAYS`
- `OPERATIONS_RENEWAL_REMINDER_DAYS`
